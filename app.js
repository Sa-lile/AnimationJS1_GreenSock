...
window.onload = function() {
    ...
    if(window.matchMedia("(min-width: 1000px)").matches){
         ...
         /* à gauche, durée 2s décrivent   
            easeInOut: la vitesse à laquelle un paramètre change en fonction du temps.décrivent la vitesse à laquelle un paramètre change en fonction du temps.*/
    tl           
      ...
      .from('h1', 1, {opacity: 0, x: 200, ease: Expo.easeInOut}, 3,5)
      .from('.social li', 0.75, {opacity: 0, y: 360, ease: Expo.easeInOut}, 4)
    ...
    .staggerFrom('i', 0.5, {opacity: 0, y: -160, ease: Expo.easeInOut}, 0.35, 1.25)
} 
} 